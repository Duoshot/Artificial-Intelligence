...
public class Labs {
    ...
    private boolean constrCL(Schedule sched, int index)
    {
    	...
    	{//look through courses
    		...
    		if((course.getCourseNumber().compareTo(courseNumber)==0) && (course.getDepartment().compareTo(department)==0))
    		{//found the correct course-lecture
	    		...
	    		{//look through the labs
	    			...
	    			{//found the lab
	    				isValid = isValid && !(sched.timeCheck(i, true, index, false));
	    				//cIndex = i;
	    				//return isValid;
	    			}
	    		}  				
