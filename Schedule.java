...
public class Schedule {
	...
	{//checks to see if the time values overlap, returns true if they do
		...
		if (first.get13Slot() && is1Course && second.get13Slot() && is2Course) return true;
		else if((first.get13Slot()) && is1Course)
		{
			is1Course = false; //813/913 exception
		} else if (second.get13Slot() && is2Course)
		{
			is2Course = false;
		}
